# Parallel Text Export

- Source file: `custom_word_styles_example.docx`
...
本課程專為想要了解成為或作為耶穌跟隨者有何意義的人而設計。許多尋求這方面知識的人明白，他們必須從聖經中尋找答案，但在尋求的過程中卻因各種原因受阻（例如：被聖經的篇幅嚇退、不知從何讀起、試著讀聖經卻看不懂、感到氣餒等）。

---

## Element 4

- element_id: `24ef2f4ac85e`
- batch_number: `2`
- status: finalized
...
這是一份**自主學習**材料，旨在協助你尋找答案。它的目的是帶領你快速瀏覽精選的聖經書卷，為你提供一個**「全局」**概覽，讓你了解成為或作為一名耶穌跟隨者的意義，並讓你熟悉聖經——對於那些想要跟隨耶穌的人來說，這是一本權威的手冊。為了獲得最大的益處，請計畫在接下來的幾週內，每天花費大約**30分鐘**。

---

## Element 5

- element_id: `083f0de61472`
- batch_number: `3`
- status: finalized
...
本課程包含**兩個部分**：第一部分涵蓋基礎知識，可在兩週內完成。第二部分「深入探討」聖經，需要額外五週的時間每天閱讀。這項學習為理解聖經以及成為耶穌跟隨者的意義奠定了基礎。

---

## Element 6

- element_id: `00764d996d76`
- batch_number: `3`
- status: finalized
...
完成本課程後，你將**得到裝備、獲得能力並充滿熱忱地**繼續學習聖經。
...
大多數剛接觸聖經的人，會像閱讀其他書籍一樣來讀聖經——他們從頭開始，按順序一直讀到最後。

---

## Element 9

- element_id: `224d9cd39e1a`
- batch_number: `4`
- status: finalized
...
然而，這往往會帶來挫折感，因為線性的閱讀方式無法幫助你輕易地***在閱讀的當下***明白聖經。本課程採取不同的方法，帶領你以**非順序的**方式來閱讀聖經各卷書。因此，這能幫助你在閱讀的同時對聖經的全貌有**更深入的了解**——也就是說，隨著你按著每日的閱讀進度前進，你會越來越明白聖經在說什麼。
...
你需要一本**聖經**和一支**鉛筆**或**螢光筆**。

---

## Element 12

- element_id: `5291a05553d1`
- batch_number: `5`
- status: finalized
...
本課程不一定要購買研讀版聖經，但從長遠來看，使用研讀本聖經來開始本課程對你可能會大有裨益。如果英文是你的母語，請選擇現代的聖經譯本——NIV、NRSV、NASB、ESV和NKJV都是極佳的選擇——但在本課程的研讀中，請避免使用意譯本。（意譯本對於從不同角度理解希臘文或希伯來文原文中的詞彙極為有用，但這類型的研讀應該留待你未來進深時再進行。）

---

## Element 13

- element_id: `3ae6137cb043`
- batch_number: `5`
- status: finalized
...
本課程需要大約 **20-40** 分鐘專注、**不受打擾的每日閱讀**。每天在開始閱讀前，請向上帝禱告，求聖靈賜你洞察力與悟性，以明白你即將閱讀的內容。

---

## Element 16

- element_id: `97f17b1381a8`
- batch_number: `6`
- status: finalized
...
請在不略讀或速讀的情況下，**盡可能快地**閱讀所選的聖經經文（如果你使用的是研讀本聖經，**請勿停下來**閱讀註釋，或者盡量少讀）。如果你注意到感興趣的經文，可以使用螢光筆標記或用鉛筆畫線，但此時還不要停下來默想（課程結束時將會提供指引，教導如何默想式地閱讀聖經，以及如何有效地使用研讀本聖經與其他註釋書）。

---

## Element 17

- element_id: `3948ff790027`
- batch_number: `7`
- status: finalized
...
重要的是要**每天閱讀**——漏掉一兩天會讓你更難記住上次讀到哪裡，也會讓你更難建立對聖經的「全貌」觀。

---

## Element 18

- element_id: `63ccfcdcd12e`
- batch_number: `7`
- status: finalized
...
聖經由**希伯來**經典和**希臘**經典所組成。

---

## Element 20

- element_id: `f61e7943bb8a`
- batch_number: `8`
- status: finalized
...
**希伯來**聖經包含**39卷書**，由許多不同的作者在約公元前1400至400年間，歷經一千年的時間寫成。除了少數段落外，它完全是用希伯來文寫成的。本研究稍後將對希伯來聖經作更詳細的說明，但就本簡介的目的而言，只需總結：希伯來聖經整體講述了創造主上帝交託給一個名叫亞伯拉罕的後裔——**以色列人**——一項特別且獨特的任務。這項任務的目的是以色列人受「委託」，要向世界上所有其他人傳揚這位**創造主上帝**。希伯來聖經包含許多關於彌賽亞（希伯來文的意思是救主或拯救者）降臨的記載。

---

## Element 21

- element_id: `538cd647d4cd`
- batch_number: `9`
- status: finalized
...
**希臘文**聖經包含**27卷書**，同樣由幾位不同的作者在約50年的期間內寫成，大約在公元40-90年。希臘文聖經展示了造物主上帝如何藉著成為人類進入歷史，成就了希伯來文聖經中關於那位將要來的**彌賽亞**（救主）的記載。彌賽亞是亞伯拉罕的後裔，名叫耶書亞（約書亞），或按英文翻譯為：耶穌。彌賽亞的希臘文是 Christos，**基督**這個稱呼即源自於此。今天，我們將名字和稱呼放在一起：耶穌基督。

---

## Element 23

- element_id: `386b209ebaa9`
- batch_number: `9`
- status: finalized

### Source

Image: New Testament Structure and Timeline
...
大多數的書卷被劃分為多個**章**（少數篇幅最短的書卷只有一章且不標示章號），而每一章又被劃分為多個**節**。一節通常包含一兩個句子。即使是不熟悉聖經的人，可能也聽過有人引用或提及**約翰福音3:16**。這指的是**約翰福音，第3章，第16節**。在聖經中查找書卷時，請參考目錄。在這個例子中，約翰這卷書（或者按其較長的書名被稱為《約翰福音》），位於聖經較後面的部分。找到《約翰福音》後，往後翻幾頁，直到翻到第3章。在大多數的聖經中，章號的字體會比其他內文大得多，而節號則是嵌入在內文中的小型上標數字。**請看範例：**

---

## Element 27

- element_id: `351e14930ad4`
- batch_number: `12`
- status: finalized
...
**約翰福音 3:16** 16神愛世人，甚至將他的獨生子賜給他們，叫一切信他的，不致滅亡，反得永生。
...
一般來說，使用您的第一語言能讓您最透徹地理解聖經，因此如果您的母語有相應的譯本，請隨意使用。如果您精通雙語，請使用您最習慣的語言。
